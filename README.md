# 💫 About Me:
🔧 Embedded-разработчик | 🚁 FPV-пилот | 🦈 Контрибьютор Open Source<br><br>Создаю то, что работает. Поддерживаю несколько проектов, <br>перевожу документацию для FPV-сообщества. Верю в открытое железо и открытый код.<br><br>Сейчас ковыряю: `aircore` — мой любимый проект для мониторинга климата, <br>CO₂ и погоды.


## 🌐 Socials:
[![TikTok](https://img.shields.io/badge/TikTok-%23000000.svg?logo=TikTok&logoColor=white)](https://tiktok.com/@@liyavr9) [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:lbkmzc942@gmail.com) 
